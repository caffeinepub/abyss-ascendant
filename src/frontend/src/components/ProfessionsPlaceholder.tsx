import { Fish, FlaskConical, Hammer, Wrench } from "lucide-react";
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-6 space-y-4">
        <div className="panel rounded-sm p-6 text-center space-y-4">
          ...
          <p className="text-muted-foreground font-body text-base leading-relaxed max-w-md mx-auto">
            The ancient crafting halls are being restored. Soon, adventurers
            will be able to forge weapons, brew potions, transmute materials,
            and master the forgotten arts of the deep.
          </p>
            ...
            {[
              {
                icon: Hammer,
                name: "Smithing",
                desc: "Forge and enhance weapons & armor",
              },
              {
                icon: FlaskConical,
                name: "Alchemy",
                desc: "Brew potions and transmute materials",
              },
              {
                icon: Wrench,
                name: "Tinkering",
                desc: "Craft trinkets and magical devices",
              },
              {
                icon: Fish,
                name: "Gathering",
                desc: "Harvest rare materials from the deep",
              },
