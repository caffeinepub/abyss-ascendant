      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="username" className="text-foreground font-gothic text-sm tracking-wide">
              Adventurer Name
            </Label>
            <Input
              id="username"
          ...
          <div className="panel-ember rounded-sm p-3 text-xs text-muted-foreground">
            <p>Your name will appear on the <span className="text-dungeon-gold">Eternal Ladder</span> and in the marketplace. Choose something memorable.</p>
          </div>
