        ...
        {[...Array(12)].map((_, i) => (
          <div
            ...
            style={{
              ...
              top: `${Math.random() * 100}%`,
              background: i % 3 === 0 ? '#ff6b35' : i % 3 === 1 ? '#ffd700' : '#9c27b0',
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 max-w-lg w-full">
        ...
        <div className="grid grid-cols-3 gap-4 w-full">
          {[
            ...
            <div key={label} className="panel rounded-lg p-3 text-center">
              ...
              <div className="font-gothic text-xs text-dungeon-gold">{label}</div>
        ...
        <div className="panel rounded-sm p-4 text-center max-w-sm">
          <p className="font-body text-sm text-muted-foreground italic leading-relaxed">
            "The Abyss calls to those brave enough to answer. Descend through the Catacombs,
            face the Ascension Trials, and claim your place on the eternal ladder."
          </p>
        </div>
      </div>
    </div>
