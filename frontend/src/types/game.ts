 ...
 */
export function calculateUnspentStatPoints(earnedOrChar: number | LocalCharacter, spent?: number): number {
  if (typeof earnedOrChar === 'object') {
    return Math.max(0, earnedOrChar.totalStatPointsEarned - earnedOrChar.totalStatPointsSpent);
  }
 ...
 */
export function applyClassStatBonus(stats: BaseStats, characterClass: CharacterClass): BaseStats {
